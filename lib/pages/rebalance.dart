...
class RebalanceSettings extends StatefulWidget {
  @override
  _RebalanceSettingsState createState() => _RebalanceSettingsState();
}

class _RebalanceSettingsState extends State<RebalanceSettings> {
              ...
              children: [
                Container(
                  ...
                  child: SwitcherButton(
                    switcherTextString: ['7 day', '14 day', '21 day'],
                  ),
                ),
                SizedBox(height: 30),
                Row(
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Your blacklist', style: blockSubtitleStyle),
                            SizedBox(height: 20),
                            SearchBar(
