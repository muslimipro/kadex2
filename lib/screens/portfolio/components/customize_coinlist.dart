...
class CustomizeCoinList extends StatefulWidget {
  @override
  _CustomizeCoinListState createState() => _CustomizeCoinListState();
}

class _CustomizeCoinListState extends State<CustomizeCoinList> {
